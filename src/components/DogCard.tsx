      ...
      <div
        ...
        <div className="relative aspect-[3/4] overflow-hidden rounded-t-2xl">
          ...
          <button onClick={handleVote}
            className={`absolute bottom-4 right-4 flex items-center gap-2 px-4 py-2.5 rounded-full font-semibold text-sm shadow-lg transition-all duration-300 active:scale-95 ${
